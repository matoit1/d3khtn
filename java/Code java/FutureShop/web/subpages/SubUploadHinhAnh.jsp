...
<form  name="frmUploadHinhAnh" method="post" enctype='multipart/form-data' action="UploadHinhAnh.do?maSP=${maSP}&uploaded=true">
    <table width="50%" border="1" align="center">
        <tr>
            <td>Select file upload  (jpg, png, gif)</td>
        </tr>
        <tr>
            <td>
                <input type="file" name="fileupload"  multiple ="true" />
                <input type="submit" name="btUpload" value="Add images"/>
            </td>
        </tr>
    </table>
</form>