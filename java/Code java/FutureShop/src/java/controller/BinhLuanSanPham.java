 ...
 * @author TRANTRI
 */
@WebServlet(name = "BinhLuanSanPham", urlPatterns = {"/BinhLuanSanPham.do"})
public class BinhLuanSanPham extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //chuyen den trang
            RequestDispatcher rd = getServletContext().getRequestDispatcher("/ChiTietSanPham.do?maSp=" + maSp);
