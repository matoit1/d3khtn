 ...
 */
@WebServlet(name = "XemChiTietDonDatHang", urlPatterns = {"/XemChiTietDonDatHang.do"})
public class XemChiTietDonDatHang extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String url = "XemChiTietDonDatHang.jsp";
